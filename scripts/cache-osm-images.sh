...
sed -i 's#"flomesh/pipy-repo:latest"#"localhost:5000/flomesh/pipy-repo:latest"#g' "${OSM_HOME}"/charts/osm/values.yaml
sed -i 's#"flomesh/pipy-repo-nightly:latest"#"localhost:5000/flomesh/pipy-repo-nightly:latest"#g' "${OSM_HOME}"/charts/osm/values.yaml