...
mcs-up:
	...
	FSM_NAMESPACE=flomesh FSM_VERSION=0.2.0-alpha.10 FSM_CHART=${FSM}/charts/fsm KIND_CLUSTER_NAME=control-plane scripts/mcs-deploy-fsm-control-plane.sh
	FSM_NAMESPACE=flomesh FSM_VERSION=0.2.0-alpha.10 FSM_CHART=${FSM}/charts/fsm KIND_CLUSTER_NAME=cluster1 scripts/mcs-deploy-fsm-control-plane.sh
	FSM_NAMESPACE=flomesh FSM_VERSION=0.2.0-alpha.10 FSM_CHART=${FSM}/charts/fsm KIND_CLUSTER_NAME=cluster2 scripts/mcs-deploy-fsm-control-plane.sh
	FSM_NAMESPACE=flomesh FSM_VERSION=0.2.0-alpha.10 FSM_CHART=${FSM}/charts/fsm KIND_CLUSTER_NAME=cluster3 scripts/mcs-deploy-fsm-control-plane.sh
