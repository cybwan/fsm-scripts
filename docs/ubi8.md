...
```bash
helm repo add fsm-edge-ubi https://flomesh-io.github.io/fsm-edge
helm repo update
export fsm_namespace=fsm-system 
export fsm_mesh_name=fsm
helm install --namespace "${fsm_namespace}" "${fsm_mesh_name}" fsm-edge-ubi/fsm-edge \
...
helm repo remove fsm-edge-ubi
```

### 1.2 本地仓库部署

```bash
helm install fsm fsm-edge/fsm charts/fsm
...
cd chart-verifier
chart-verifier verify https://flomesh-io.github.io/fsm-edge/fsm-edge-1.2.1-ubi8.tgz
```
