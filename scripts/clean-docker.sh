...
IMG="flomesh/osm-edge-demo-tcp-echo-server"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-healthcheck"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-preinstall"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-bootstrap"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-injector"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-controller"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-crds"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
IMG="flomesh/osm-edge-sidecar-init"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
...
IMG="envoyproxy/envoy:v1.19.3"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
...
IMG="flomesh/proxy-wasm-cpp-sdk:v2"; docker rmi "${IMG}" "${LOCAL_REGISTRY}/${IMG}"
