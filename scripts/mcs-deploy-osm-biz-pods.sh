...
#集群 cluster1 部署不被 osm edge 纳管的业务服务
...
#集群 cluster1 部署被 osm edge 纳管的业务服务
kubecm switch kind-cluster1
...
#集群 cluster3 部署不被 osm edge 纳管的业务服务
...
#集群 cluster3 部署被 osm edge 纳管的业务服务
kubecm switch kind-cluster3
#kubectl create namespace pipy-osm
osm namespace add pipy-osm
...
#集群 cluster2 部署被 osm edge 纳管的客户端
kubecm switch kind-cluster2
