...
kubectl apply -n pipy -f https://raw.githubusercontent.com/cybwan/fsm-edge-start-demo/main/demo/multi-cluster/pipy-ok-c1.pipy.yaml
#等待依赖的 POD 正常启动
sleep 10
...
kubectl apply -n pipy-fsm -f https://raw.githubusercontent.com/cybwan/fsm-edge-start-demo/main/demo/multi-cluster/pipy-ok-c1.pipy-fsm.yaml
#等待依赖的 POD 正常启动
sleep 10
...
#kubectl create namespace pipy
kubectl apply -n pipy -f https://raw.githubusercontent.com/cybwan/fsm-edge-start-demo/main/demo/multi-cluster/pipy-ok-c3.pipy.yaml
#等待依赖的 POD 正常启动
sleep 10
...
#kubectl create namespace pipy-fsm
fsm namespace add pipy-fsm
kubectl apply -n pipy-fsm -f https://raw.githubusercontent.com/cybwan/fsm-edge-start-demo/main/demo/multi-cluster/pipy-ok-c3.pipy-fsm.yaml
#等待依赖的 POD 正常启动
sleep 10
...
kubectl apply -n curl -f https://raw.githubusercontent.com/cybwan/fsm-edge-start-demo/main/demo/multi-cluster/curl.curl.yaml
#等待依赖的 POD 正常启动
sleep 10
