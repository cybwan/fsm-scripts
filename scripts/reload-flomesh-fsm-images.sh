...
docker tag docker.io/flomesh/fsm-ingress-pipy:0.2.0-alpha.1-dev localhost:5000/flomesh/fsm-ingress-pipy:0.2.0-alpha.1-dev
docker tag docker.io/flomesh/fsm-manager:0.2.0-alpha.1-dev localhost:5000/flomesh/fsm-manager:0.2.0-alpha.1-dev
...
docker push localhost:5000/flomesh/fsm-ingress-pipy:0.2.0-alpha.1-dev
docker push localhost:5000/flomesh/fsm-manager:0.2.0-alpha.1-dev
