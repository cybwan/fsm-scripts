...
docker pull docker.io/flomesh/fsm-ingress-pipy:0.2.0-alpha.3-dev
docker pull docker.io/flomesh/fsm-manager:0.2.0-alpha.3-dev
...
docker tag docker.io/flomesh/fsm-ingress-pipy:0.2.0-alpha.3-dev localhost:5000/flomesh/fsm-ingress-pipy:0.2.0-alpha.3-dev
docker tag docker.io/flomesh/fsm-manager:0.2.0-alpha.3-dev localhost:5000/flomesh/fsm-manager:0.2.0-alpha.3-dev
...
docker push localhost:5000/flomesh/fsm-ingress-pipy:0.2.0-alpha.3-dev
docker push localhost:5000/flomesh/fsm-manager:0.2.0-alpha.3-dev
...
IMG="flomesh/fsm-ingress-pipy:0.2.0-alpha.3-dev"; docker rmi "${IMG}" "localhost:5000/${IMG}"
IMG="flomesh/fsm-manager:0.2.0-alpha.3-dev"; docker rmi "${IMG}" "localhost:5000/${IMG}"
