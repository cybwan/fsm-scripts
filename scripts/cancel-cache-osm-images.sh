...
find "${OSM_HOME}"/dockerfiles -type f -exec sed -i 's# localhost:5000/cybwan/gcr.io.distroless.base# gcr.io/distroless/base#g' {} +
find "${OSM_HOME}"/dockerfiles -type f -exec sed -i 's# localhost:5000/cybwan/gcr.io.distroless.static# gcr.io/distroless/static#g' {} +
