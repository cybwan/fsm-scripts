...
```bash
helm repo add fsm-ubi https://flomesh-io.github.io/fsm
helm repo update
export fsm_namespace=fsm-system 
export fsm_mesh_name=fsm
helm install --namespace "${fsm_namespace}" "${fsm_mesh_name}" fsm-ubi/fsm \
...
helm repo remove fsm-ubi
```

### 1.2 本地仓库部署

```bash
helm install fsm fsm/fsm charts/fsm
...
cd chart-verifier
chart-verifier verify https://flomesh-io.github.io/fsm/fsm-1.2.1-ubi8.tgz
```
