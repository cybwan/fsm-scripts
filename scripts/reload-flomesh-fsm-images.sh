...
IMG="flomesh/fsm-ingress-pipy:0.2.0-alpha.4-dev"; docker rmi "${IMG}" "localhost:5000/${IMG}"
IMG="flomesh/fsm-manager:0.2.0-alpha.4-dev"; docker rmi "${IMG}" "localhost:5000/${IMG}"
...
docker exec $REGPOD rm -rf /var/lib/registry/docker/registry/v2/repositories/flomesh/fsm-ingress-pipy:0.2.0-alpha.4-dev
docker exec $REGPOD rm -rf /var/lib/registry/docker/registry/v2/repositories/flomesh/fsm-manager:0.2.0-alpha.4-dev
...
docker pull docker.io/flomesh/fsm-ingress-pipy:0.2.0-alpha.4-dev
docker pull docker.io/flomesh/fsm-manager:0.2.0-alpha.4-dev
...
docker tag docker.io/flomesh/fsm-ingress-pipy:0.2.0-alpha.4-dev localhost:5000/flomesh/fsm-ingress-pipy:0.2.0-alpha.4-dev
docker tag docker.io/flomesh/fsm-manager:0.2.0-alpha.4-dev localhost:5000/flomesh/fsm-manager:0.2.0-alpha.4-dev
...
docker push localhost:5000/flomesh/fsm-ingress-pipy:0.2.0-alpha.4-dev
docker push localhost:5000/flomesh/fsm-manager:0.2.0-alpha.4-dev
